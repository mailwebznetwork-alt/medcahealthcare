    ...
    theme: {
        extend: {
            ...
            colors: {
                ...
                'mom-gold': 'var(--mom-gold)',
                'mom-wordmark': 'var(--mom-wordmark)',
                'mom-border': 'var(--mom-border)',
                'mom-border-soft': 'var(--mom-border-soft)',
                /** Public marketing shell — scoped to body.medca-public-surface */
                'medca-primary': 'var(--medca-primary)',
                'medca-text': 'var(--medca-text-primary)',
                'medca-text-secondary': 'var(--medca-text-secondary)',
                'medca-text-muted': 'var(--medca-text-muted)',
                'medca-surface': 'var(--medca-surface)',
                'medca-surface-muted': 'var(--medca-surface-muted)',
                'medca-surface-elevated': 'var(--medca-surface-elevated)',
                'medca-border': 'var(--medca-border)',
                'medca-navy': 'var(--medca-navy)',
                'medca-navy-mid': 'var(--medca-navy-mid)',
                'medca-navy-border': 'var(--medca-navy-border)',
                'medca-primary-hover': 'var(--medca-primary-hover)',
