...
test('full backup archive round trips sqlite database and storage directories', function (): void {
    ...
    $zip = $base.DIRECTORY_SEPARATOR.'export.zip';

    $packer = new MomFullBackupArchive($dbLive, $base.DIRECTORY_SEPARATOR.'pub', $base.DIRECTORY_SEPARATOR.'priv');
    ...
    $restore = new MomFullBackupArchive($dbLive, $base.DIRECTORY_SEPARATOR.'pub', $base.DIRECTORY_SEPARATOR.'priv');
