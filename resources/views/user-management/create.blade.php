                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <x-text-input
                            ...
                            variant="mom"
                        />
                        <p class="mom-subtext mt-1">{{ __('Operational designation only ù access is controlled by modules below.') }}</p>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input
                            ...
                            type="file"
                            accept="image/*"
                            class="mt-1 block w-full text-sm text-[var(--text-secondary)] file:mr-4 file:rounded-full file:border-0 file:bg-[rgba(197,160,89,0.12)] file:px-4 file:py-2 file:text-xs file:font-semibold file:uppercase file:tracking-wide file:text-mom-gold"
                        />
