@foreach (\App\ModuleAccess::labelsForForm() as $key => $meta)
    ...
    <label @class([
        ...
        'cursor-pointer hover:border-[rgba(212,169,95,0.16)]' => ! $disabled,
        ...
        <input
            ...
            value="1"
            class="mt-1 h-4 w-4 rounded border-[rgba(255,255,255,0.12)] bg-[rgba(28,22,18,0.75)] text-mom-gold shadow-inner focus:ring-1 focus:ring-[rgba(212,169,95,0.35)] disabled:opacity-50"
            @checked($checked)
            @disabled($disabled)
        />
        <span class="min-w-0">
