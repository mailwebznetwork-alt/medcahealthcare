...
@php
    $baseClass = match ($variant) {
        'mom' => 'mom-control-pill inline-flex items-center justify-center border border-[rgba(226,92,92,0.35)] bg-[rgba(226,92,92,0.12)] px-5 py-2.5 text-xs font-semibold uppercase tracking-widest text-[var(--danger)] transition-all duration-320 ease-premium hover:border-[rgba(226,92,92,0.55)] hover:bg-[rgba(226,92,92,0.18)] focus:outline-none focus:ring-2 focus:ring-[rgba(226,92,92,0.45)] focus:ring-offset-2 focus:ring-offset-[var(--bg-app)]',
