...
@php
    $baseClass = match ($variant) {
        ...
        'public' => 'rounded-lg border border-slate-300 bg-white text-sm text-slate-900 shadow-sm placeholder:text-slate-400 focus:border-medca-primary focus:ring-1 focus:ring-medca-primary',
