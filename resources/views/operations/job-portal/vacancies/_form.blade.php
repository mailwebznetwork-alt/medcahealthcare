    ...
    <div class="mom-card p-6">
        ...
        <div class="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
                ...
                <select id="employment_type" name="employment_type" class="mt-2 block w-full rounded-mom-chrome border-[rgba(255,255,255,0.045)] bg-[rgba(28,22,18,0.75)] px-3 py-2.5 text-sm text-[var(--text-primary)] shadow-mom-inner focus:border-[rgba(197,160,89,0.28)] focus:outline-none focus:ring-1 focus:ring-[rgba(197,160,89,0.22)]">
    ...
    <div class="mom-card p-6">
        ...
        <div class="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
            <div>
                ...
                <select id="workflow_status" name="workflow_status" class="mt-2 block w-full rounded-mom-chrome border-[rgba(255,255,255,0.045)] bg-[rgba(28,22,18,0.75)] px-3 py-2.5 text-sm text-[var(--text-primary)] shadow-mom-inner focus:border-[rgba(197,160,89,0.28)] focus:outline-none focus:ring-1 focus:ring-[rgba(197,160,89,0.22)]">
            ...
            <div>
                ...
                <select id="visibility" name="visibility" class="mt-2 block w-full rounded-mom-chrome border-[rgba(255,255,255,0.045)] bg-[rgba(28,22,18,0.75)] px-3 py-2.5 text-sm text-[var(--text-primary)] shadow-mom-inner focus:border-[rgba(197,160,89,0.28)] focus:outline-none focus:ring-1 focus:ring-[rgba(197,160,89,0.22)]">
            ...
            <div class="flex items-center gap-3 pt-2">
                <input id="is_active" name="is_active" type="checkbox" value="1" class="h-4 w-4 rounded border-[rgba(255,255,255,0.12)] bg-[rgba(28,22,18,0.75)] text-mom-gold focus:ring-1 focus:ring-[rgba(197,160,89,0.35)]" @checked(old('is_active', $vacancy->is_active)) />
