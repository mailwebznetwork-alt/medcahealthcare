        ...
        <div class="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div class="md:col-span-2">
                ...
                <textarea
                    ...
                    rows="4"
                    class="mt-2 block w-full mom-control-pill border-[rgba(255,255,255,0.045)] bg-[rgba(28,22,18,0.75)] px-3 py-2.5 text-sm text-[var(--text-primary)] shadow-mom-inner placeholder:text-[var(--text-muted)] focus:border-[rgba(197,160,89,0.28)] focus:outline-none focus:ring-1 focus:ring-[rgba(197,160,89,0.22)]"
