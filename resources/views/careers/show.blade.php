                ...
                <div class="mom-card p-6">
                    ...
                    <form method="post" action="{{ route('careers.apply', ['slug' => $vacancy->slug]) }}" class="mt-6 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="cover_message" name="cover_message" rows="4" class="mt-2 block w-full mom-control-pill border-[rgba(255,255,255,0.045)] bg-[rgba(28,22,18,0.75)] px-3 py-2.5 text-sm text-[var(--text-primary)] shadow-mom-inner">{{ old('cover_message') }}</textarea>
                        </div>
